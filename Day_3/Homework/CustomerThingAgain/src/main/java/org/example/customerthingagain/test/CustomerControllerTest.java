...
public class CustomerControllerTest {
    ...
    public void testGetAllCustomers() {
        ...
        assertEquals(customers, customerController.getAllCustomers());
    ...
    public void testGetCustomerById() {
        ...
        assertEquals(customer, customerController.getCustomerById(customerId));
    ...
    public void testAddCustomer() {
        ...
        assertEquals(customer, customerController.addCustomer(customer));
